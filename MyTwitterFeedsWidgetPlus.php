...
<?php
  ...
  <div class="mod_twitter_widget_plus" style="width: <?php echo $width; ?>px;">
		...
		<div class="link-item" style="font-size: 9px; color: #ccc; text-align: right; position: relative; top: -15px;"><a href="http://www.novusglassrepair.com/" target="_blank" style="color: #808080;" title="Click here">Novusglassrepair.com</a></div>
